...
class Product extends Model
{
    ...
    public function insert()
    {
        $obj_insert = $this->connection
            ->prepare("INSERT INTO products(category_id, title, avatar, price, weight, id_supplier, summary, content, hot, status) 
                                VALUES (:category_id, :title, :avatar, :price, :weight, :id_supplier, :summary, :content, :hot, :status)");
        $arr_insert = [
    ...
    public function update($id)
    {
        $obj_update = $this->connection
            ->prepare("UPDATE products SET category_id=:category_id, title=:title, avatar=:avatar, price=:price, weight=:weight,
             id_supplier=:id_supplier, summary=:summary, content=:content, hot=:hot, status=:status, updated_at=:updated_at WHERE id = $id
");
        $arr_update = [
            ':category_id' => $this->category_id,
            ':title' => $this->title,
